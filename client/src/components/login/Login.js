...
const Login = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url("https://i.ibb.co/9Vzvq3N/hyderabad.webp")`,
      ...
      <div className="flex flex-col items-center mt-10 space-y-32">
        ...
        <div className="h-96 w-96 space-y-11 shadow-2xl flex flex-col justify-center items-center bg-transparent backdrop-blur-md bg-[#198754] bg-opacity-60 rounded-xl">
          ...
          <div className="h-96 w-96 space-y-11 shadow-2xl flex flex-col justify-center items-center bg-transparent backdrop-blur-md bg-[#fd7e14] bg-opacity-60 rounded-xl">
