...
const AdminLogin = () => {
  ...
  return (
    <div className="bg-[#198754] h-screen w-screen flex items-center justify-center">
      <div className="grid grid-cols-1">
        <form
          onSubmit={login}
          className={`${
            loading ? "h-[27rem]" : "h-96"
          } w-96 bg-[#2c2f35] flex flex-col items-center justify-center rounded-3xl shadow-2xl`} >
